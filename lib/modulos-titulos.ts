...
export const TITULOS_MODULO: Record<string, Record<string, string>> = {
  ...
  POE: {
    "1": "Poder de polícia, ordem pública e polícia ostensiva",
    "2": "Características e princípios do policiamento ostensivo",
    "3": "Variáveis: tipos, processos, modalidades e circunstâncias",
    "4": "Órgãos da segurança pública e desdobramento da PMPE",
    "5": "DIRESP, DASDH e programas institucionais",
    "6": "Planejamento: 3ª EMG, documentos, PDCA e Juntos pela Segurança",
  ...
  AM: {
    ...
    "3": "Munição: calibres, componentes e espoletamento",
    "4": "Balística, o cano, trajetória e poder de parada",
    "5": "Fundamentos do tiro: posição, empunhadura e visada",
    "6": "Procedimentos, recargas, panes e segurança",
    SIM: "Simulado — formato da prova (10,0 pontos · 100 min)",
  },
  DADM: {
